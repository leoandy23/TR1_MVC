...
<body>
	...
	<div class="container my-3">
		<form action="AsignarTareaController" method="POST" class="w-50 mx-auto shadow p-3 rounded">
			<h2>Asignar tarea</h2>
			<div class="input-group mb-3">
				<label class="input-group-text" for="idtask">ID Tarea:</label> <input
					id="id" name="id" type="text" class="form-control"
					placeholder="Ingrese el nombre de la tarea" value="${tarea.codigo}"
					readonly />
			</div>
			<div class="input-group mb-3">
				<label class="input-group-text" for="taskname">Nombre Tarea:</label>
				<input id="taskname" name="taskname" type="text"
					class="form-control" placeholder="Ingrese el nombre de la tarea"
					value="${tarea.nombre}" readonly />
			</div>
			<div class="input-group mb-3">
